...
alter table `{{params.reporting_database}}`.`uspc_current` add fulltext index `fti_uspc_current_mainclass_title` (`mainclass_title`);
alter table `{{params.reporting_database}}`.`uspc_current` add fulltext index `fti_uspc_current_subclass_title` (`subclass_title`);
