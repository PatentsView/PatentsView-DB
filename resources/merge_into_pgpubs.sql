...
--     SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2021;

INSERT INTO pgpubs_text.brf_sum_text_2020 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2020;

INSERT INTO pgpubs_text.brf_sum_text_2019 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2019;

INSERT INTO pgpubs_text.brf_sum_text_2018 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2018;

INSERT INTO pgpubs_text.brf_sum_text_2017 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2017;

INSERT INTO pgpubs_text.brf_sum_text_2016 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2016;

INSERT INTO pgpubs_text.brf_sum_text_2015 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2015;

INSERT INTO pgpubs_text.brf_sum_text_2014 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2014;

INSERT INTO pgpubs_text.brf_sum_text_2013 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2013;

INSERT INTO pgpubs_text.brf_sum_text_2012 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2012;

INSERT INTO pgpubs_text.brf_sum_text_2011 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2011;

INSERT INTO pgpubs_text.brf_sum_text_2010 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2010;

INSERT INTO pgpubs_text.brf_sum_text_2009 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2009;

INSERT INTO pgpubs_text.brf_sum_text_2008 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2008;

INSERT INTO pgpubs_text.brf_sum_text_2007 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2007;

INSERT INTO pgpubs_text.brf_sum_text_2006 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2006;

INSERT INTO pgpubs_text.brf_sum_text_2005 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2005;

INSERT INTO pgpubs_text.brf_sum_text_2004 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2004;

INSERT INTO pgpubs_text.brf_sum_text_2003 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2003;

INSERT INTO pgpubs_text.brf_sum_text_2002 (`id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `summary_text`, `filename`, `version_indicator` FROM `{{source_database}}`.brf_sum_text_2002;
...
--     SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2021;

INSERT INTO pgpubs_text.detail_desc_text_2020 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2020;

INSERT INTO pgpubs_text.detail_desc_text_2019 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2019;

INSERT INTO pgpubs_text.detail_desc_text_2018 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2018;

INSERT INTO pgpubs_text.detail_desc_text_2017 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2017;

INSERT INTO pgpubs_text.detail_desc_text_2016 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2016;

INSERT INTO pgpubs_text.detail_desc_text_2015 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2015;

INSERT INTO pgpubs_text.detail_desc_text_2014 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2014;

INSERT INTO pgpubs_text.detail_desc_text_2013 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2013;

INSERT INTO pgpubs_text.detail_desc_text_2012 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2012;

INSERT INTO pgpubs_text.detail_desc_text_2011 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2011;

INSERT INTO pgpubs_text.detail_desc_text_2010 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2010;

INSERT INTO pgpubs_text.detail_desc_text_2009 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2009;

INSERT INTO pgpubs_text.detail_desc_text_2008 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2008;

INSERT INTO pgpubs_text.detail_desc_text_2007 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2007;

INSERT INTO pgpubs_text.detail_desc_text_2006 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2006;

INSERT INTO pgpubs_text.detail_desc_text_2005 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2005;

INSERT INTO pgpubs_text.detail_desc_text_2004 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2004;

INSERT INTO pgpubs_text.detail_desc_text_2003 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2003;

INSERT INTO pgpubs_text.detail_desc_text_2002 (`id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `description_text`, `description_length`, `filename`, `version_indicator` FROM `{{source_database}}`.detail_desc_text_2002;
...
--     SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2021;

INSERT INTO pgpubs_text.draw_desc_text_2020 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2020;

INSERT INTO pgpubs_text.draw_desc_text_2019 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2019;

INSERT INTO pgpubs_text.draw_desc_text_2018 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2018;

INSERT INTO pgpubs_text.draw_desc_text_2017 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2017;

INSERT INTO pgpubs_text.draw_desc_text_2016 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2016;

INSERT INTO pgpubs_text.draw_desc_text_2015 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2015;

INSERT INTO pgpubs_text.draw_desc_text_2014 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2014;

INSERT INTO pgpubs_text.draw_desc_text_2013 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2013;

INSERT INTO pgpubs_text.draw_desc_text_2012 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2012;

INSERT INTO pgpubs_text.draw_desc_text_2011 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2011;

INSERT INTO pgpubs_text.draw_desc_text_2010 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2010;

INSERT INTO pgpubs_text.draw_desc_text_2009 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2009;

INSERT INTO pgpubs_text.draw_desc_text_2008 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2008;

INSERT INTO pgpubs_text.draw_desc_text_2007 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2007;

INSERT INTO pgpubs_text.draw_desc_text_2006 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2006;

INSERT INTO pgpubs_text.draw_desc_text_2005 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2005;

INSERT INTO pgpubs_text.draw_desc_text_2004 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2004;

INSERT INTO pgpubs_text.draw_desc_text_2003 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2003;

INSERT INTO pgpubs_text.draw_desc_text_2002 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2002;

INSERT INTO pgpubs_text.draw_desc_text_2001 (`id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator`) 
    SELECT `id`, `pgpub_id`, `draw_desc_text`, `draw_desc_sequence`, `filename`, `version_indicator` FROM `{{source_database}}`.draw_desc_text_2001;
