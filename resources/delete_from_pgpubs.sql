...
delete from pgpubs_text.brf_sum_text_2023 where version_indicator = '{{dbdate}}';
delete from pgpubs_text.brf_sum_text_2022 where version_indicator = '{{dbdate}}';
delete from pgpubs_text.claims_2023 where version_indicator = '{{dbdate}}';
...
delete from pgpubs_text.detail_desc_text_2023 where version_indicator = '{{dbdate}}';
delete from pgpubs_text.draw_desc_text_2023 where version_indicator = '{{dbdate}}';
