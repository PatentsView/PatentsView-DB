...
from updater.disambiguation.assignee_disambiguation.assignee_disambiguator import (
    build_assignee_name_mentions,
    run_hierarchical_clustering as run_assignee_hierarchical_clustering,
    create_uuid_map,
    upload_results as upload_assignee_results,
    archive_results as archive_assignee_results,
    finalize_assignee_clustering,
    qc_build_assignee_name_mentions,
)
from updater.disambiguation.inventor_disambiguation.inventor_disambiguator import (
    build_assignee_features,
    build_canopies,
    archive_results as archive_inventor_results,
    build_coperson_features,
    # build_coinventor_features,
    build_title_map,
    run_hierarchical_clustering as run_inventor_hierarchical_clustering,
    finalize_disambiguation,
    upload_results as upload_inventor_results,
    setup_inventor_assignee_disambiguation,
)
from updater.post_processing.post_process_location import (
    post_process_location,
    post_process_qc,
    augment_location_fips,
)
from updater.post_processing.post_process_assignee import (
    additional_post_processing_assignee,
    post_process_qc as qc_post_process_assignee,
    post_process_assignee_patent_phase2_qc,
    post_process_assignee_pgpubs_phase2_qc,
    post_process_assignee_qc_pgpubs,
    update_granted_rawassignee,
    update_pregranted_rawassignee,
    precache_assignees,
    create_canonical_assignees,
    load_granted_location_assignee,
    load_pregranted_location_assignee,
    create_patent_assignee,
    create_publication_assignee,
)
from updater.post_processing.post_process_inventor import (
    update_granted_rawinventor,
    update_pregranted_rawinventor,
    precache_inventors,
    create_canonical_inventors,
    create_patent_inventor,
    create_publication_inventor,
    ...
    post_process_inventor_patent_phase2_qc,
    post_process_inventor_pgpubs_phase2_qc,
    post_process_inventor_qc_pgpubs,
)
from updater.post_processing.post_process_persistent import (
    prepare_wide_table,
    # update_long_entity,
    write_wide_table,
)
from updater.post_processing.archive_disambiguation_tables import (
    archive_assignee_tables,
    archive_inventor_tables,
    archive_location_tables,
)
...
# coinventor/coperson features creates a dict of {doc_id:[surnameA, surnameB], ... } and stores it as a pickle
...
inv_build_coperson_features = PythonOperator(task_id='Inventor_Build_Co-Inventor_Features',
                                               python_callable=build_coperson_features,
                                               provide_context=True,
                                               dag=disambiguation,
                                               on_success_callback=airflow_task_success,
                                               on_failure_callback=airflow_task_failure,
...
operator_sequence = {'assignee_feat_setup': [assignee_inventor_disambig_setup, inv_build_assignee_features],
                     'coperson_feat_setup': [assignee_inventor_disambig_setup, inv_build_coperson_features],
                     ...
                     'coperson_feat': [inv_build_coperson_features, inv_run_clustering],
                     ...
                     'cross_link_1': [inv_build_coperson_features, assignee_run_clustering],
