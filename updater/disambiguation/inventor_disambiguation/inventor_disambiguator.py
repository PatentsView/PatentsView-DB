...
def setup_inventor_assignee_disambiguation(**kwargs):
    ...
    os.makedirs(os.path.dirname(f"{config['BASE_PATH']['inventor']}".format(end_date=end_date, data_root=config['FOLDERS']['data_root'])), exist_ok=True)
    os.makedirs(os.path.dirname(f"{config['BASE_PATH']['assignee']}".format(end_date=end_date, data_root=config['FOLDERS']['data_root'])), exist_ok=True)
    print(f"NEW PATH CREATED ---- {config['BASE_PATH']['inventor']}".format(end_date=end_date, data_root=config['FOLDERS']['data_root']))
