...
from updater.xml_to_sql.post_processing import consolidate_granted_cpc, clean_rawlocation_recursive
...
def patent_sql_parser(**kwargs):
    ...
    clean_rawlocation_recursive(config, applicant_table="non_inventor_applicant")
