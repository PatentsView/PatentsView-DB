    ...
    if class_called[:4] == 'Text':
        ...
        if "PostProcessing" in str(self):
            ...
            for table in tables_list:
                if table in ['assignee', "assignee_disambiguation_mapping", 'location', "location_disambiguation_mapping", 'inventor',  "inventor_disambiguation_mapping", "inventor_gender"]:
