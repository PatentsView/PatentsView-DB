...
class UploadTest(PatentDatabaseTester):
    def __init__(self, config):
        ...
        self.table_config = {'application': {
            ...
            'botanic': {'custom_float_condition': "p.type='plant'", 'fields': {
            ...
            'figures': {
                'fields': {'uuid': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           ...
                           'num_figures': {'data_type': 'int', 'null_allowed': True,
                                           'category': False},
                           'num_sheets': {'data_type': 'int', 'null_allowed': True,
                                          'category': False}}}, 'foreigncitation': {
                'fields': {'date': {'data_type': 'date', 'null_allowed': True, 'date_field': True, 'category': False},
                           'number': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
            ...
            'foreign_priority': {'fields': {
                ...
                'number': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                'uuid': {'data_type': 'varchar', 'null_allowed': False, 'category': False}}},
            'government_interest': {'fields': {
                'gi_statement': {'data_type': 'mediumtext', 'null_allowed': False, 'category': False},
                'patent_id': {'data_type': 'varchar', 'null_allowed': False, 'category': False}}},
            'ipcr': {'fields': {'ipc_version_indicator': {'data_type': 'date', 'null_allowed': True,
                                                          'category': False},
            ...
            'non_inventor_applicant': {
                'fields': {'fname': {'data_type': 'varchar', 'null_allowed': True, 'category': False},
                           ...
                           'applicant_type': {'data_type': 'varchar', 'null_allowed': True,
                                              'category': True}}}, 'otherreference': {
                'fields': {'uuid': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           'patent_id': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           'text': {'data_type': 'text', 'null_allowed': False, 'category': False},
                           'sequence': {'data_type': 'int', 'null_allowed': False, 'category': False}}}, 'patent': {
                'fields': {'type': {'data_type': 'varchar', 'null_allowed': False, 'category': True},
                           ...
                           'withdrawn': {'data_type': 'int', 'null_allowed': True, 'category': False}}}, 'pct_data': {
                'fields': {'patent_id': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           'kind': {'data_type': 'varchar', 'null_allowed': True, 'category': True},
            ...
            'rawassignee': {'fields': {
                ...
                'rawlocation_id': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                'sequence': {'data_type': 'int', 'null_allowed': False, 'category': False},
                'type': {'data_type': 'varchar', 'null_allowed': True, 'category': True},
                'uuid': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
            ...
            'rawinventor': {
                'fields': {'uuid': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           ...
                           'name_first': {'data_type': 'varchar', 'null_allowed': True,
                                          'category': False}}}, 'rawlawyer': {
                'fields': {'name_last': {'data_type': 'varchar', 'null_allowed': True, 'category': False},
                           'uuid': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           'organization': {'data_type': 'varchar', 'null_allowed': True, 'category': False},
            ...
            'rawlocation': {
                'fields': {'id': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           ...
                           'country': {'data_type': 'varchar', 'null_allowed': True,
                                       'category': True}}}, 'rel_app_text': {
                'fields': {'sequence': {'data_type': 'int', 'null_allowed': False, 'category': False},
                           'uuid': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           'patent_id': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
            ...
            'usapplicationcitation': {
                'fields': {'name': {'data_type': 'varchar', 'null_allowed': True, 'category': False},
                           'sequence': {'data_type': 'int', 'null_allowed': False, 'category': False},
                           'uuid': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           'kind': {'data_type': 'varchar', 'null_allowed': True, 'category': True},
                           ...
                           'category': {'data_type': 'varchar', 'null_allowed': True,
                                        'category': False}}}, 'uspatentcitation': {
                'fields': {'citation_id': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           'category': {'data_type': 'varchar', 'null_allowed': True, 'category': True},
                           'date': {'data_type': 'date', 'null_allowed': True, 'date_field': True, 'category': False},
                           ...
                           'kind': {'data_type': 'varchar', 'null_allowed': True, 'category': True},
                           'patent_id': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           'country': {'data_type': 'varchar', 'null_allowed': True, 'category': True}}}, 'uspc': {
                'fields': {'uuid': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           'patent_id': {'data_type': 'varchar', 'null_allowed': False, 'category': False},
                           ...
                           'sequence': {'data_type': 'int', 'null_allowed': False, 'category': False}}}, 'usreldoc': {
                'fields': {'status': {'data_type': 'varchar', 'null_allowed': True, 'category': True},
