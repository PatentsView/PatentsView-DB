...
class RenameTest:
    def __init__(self, config):
        self.empty_tables = ['application', 'botanic', 'brf_sum_text', 'claim', 'cpa', 'cpc', 'detail_desc_text',
                             'draw_desc_text', 'foreign_priority', 'further_cpc', 'ipcr', 'lawyer', 'main_cpc',
                             'pct_data', 'publication', 'rawassignee', 'rawinventor', 'rawlocation', 'rawuspc',
                             'rel_app_text', 'us_parties', 'uspc', 'usreldoc']
        self.config = config
        pass
