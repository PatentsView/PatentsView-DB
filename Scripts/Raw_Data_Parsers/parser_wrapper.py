...
if int(params.uspc_upload) == 1 and int(params.period) not in range(1,3):
    csv_to_mysql.upload_uspc(params.mysql_host,params.mysql_username,params.mysql_passwd,params.mysql_dbname,params.uspc_upload_dir)
