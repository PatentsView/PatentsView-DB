...
fd = 'Z:/share/Science Policy Portfolio/Patent Data 1976-Present/XML/2002-2004/'

diri = os.listdir(fd)
outp = csv.writer(open('c:/All_data_2002-2004.csv','ab'))
checks = open('c:/check_files-2002.txt','a')
...
fd2 = 'c:/uspto_data/2002-2004/'
error = open(fd2+'error.txt','a')
numi = 0
num = 0
for d in diri:
    print d
    ...
    for i in infile:
      try:
        ...
        application[id_generator()] = [patent_id,apptype,appnum,patcountry,appdate]
