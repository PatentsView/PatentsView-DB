            ...
            try:
                ...
                for j in ipcr_classification:
                    ...
                    for line in ipcr_fields:
                        #pattern is different in 2005 
                        if "<main-classification" in " ".join(ipcr_classification):
                            print docno
                            print ipcr_fields
                            ...
                            if line.startswith("<further-classification"):
                                furtherclass = re.search('<further-classification>(.*?)</further-classification>', line).group(1)
                        else:
