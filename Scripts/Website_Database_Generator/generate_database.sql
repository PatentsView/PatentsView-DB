...
alter table `PatentsView_20141215_dev`.`temp_location_patent` add index (`patent_id`, `location_id`);
...
update
  ...
  (
    ...
    from
      `PatentsView_20141215_dev`.`patent_assignee`
    group by
...
update
  ...
  (
    ...
    from
      `PatentsView_20141215_dev`.`patent_inventor`
    group by
...
from
  `PatentsView_20141215_dev`.`temp_location_patent` tlp
...
drop table if exists `PatentsView_20141215_dev`.`location_nber_subcategory`;
create table `PatentsView_20141215_dev`.`location_nber_subcategory`
(
  `location_id` int unsigned not null,
  `subcategory_id` varchar(20) not null,
  `num_patents` int unsigned not null
...
# 
insert into `PatentsView_20141215_dev`.`location_nber_subcategory`
  (`location_id`, `subcategory_id`, `num_patents`)
select
  tlp.`location_id`, nber.`subcategory_id`, count(distinct tlp.`patent_id`)
from
  `PatentsView_20141215_dev`.`temp_location_patent` tlp
  inner join `PatentsView_20141215_dev`.`nber` nber using(`patent_id`)
group by
...
alter table `PatentsView_20141215_dev`.`location_nber_subcategory` add index `ix_location_nber_subcategory_location_id` (`location_id`);
alter table `PatentsView_20141215_dev`.`location_nber_subcategory` add index `ix_location_nber_subcategory_mainclass_id` (`subcategory_id`);
...
alter table `PatentsView_20141215_dev`.`assignee` add index `ix_assignee_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`assignee` add index `ix_assignee_num_inventors` (`num_inventors`)
alter table `PatentsView_20141215_dev`.`assignee_cpc_subsection` add index `ix_assignee_cpc_subsection_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`assignee_inventor` add index `ix_assignee_inventor_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`assignee_nber_subcategory` add index `ix_assignee_nber_subcategory_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`assignee_uspc_mainclass` add index `ix_assignee_uspc_mainclass_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`assignee_year` add index `ix_assignee_year_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`cpc_current` add index `ix_cpc_current_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`cpc_current` add index `ix_cpc_current_num_inventors` (`num_inventors`)
alter table `PatentsView_20141215_dev`.`cpc_current` add index `ix_cpc_current_num_assignees` (`num_assignees`)
alter table `PatentsView_20141215_dev`.`cpc_current_subsection` add index `ix_cpc_current_subsection_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`cpc_current_subsection` add index `ix_cpc_current_subsection_num_inventors` (`num_inventors`)
alter table `PatentsView_20141215_dev`.`cpc_current_subsection` add index `ix_cpc_current_subsection_num_assignees` (`num_assignees`)
alter table `PatentsView_20141215_dev`.`cpc_current_subsection_patent_year` add index `ix_cpc_current_subsection_patent_year_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`inventor` add index `ix_inventor_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`inventor` add index `ix_inventor_num_assignees` (`num_assignees`)
alter table `PatentsView_20141215_dev`.`inventor_coinventor` add index `ix_inventor_coinventor_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`inventor_cpc_subsection` add index `ix_inventor_cpc_subsection_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`inventor_nber_subcategory` add index `ix_inventor_nber_subcategory_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`inventor_uspc_mainclass` add index `ix_inventor_uspc_mainclass_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`inventor_year` add index `ix_inventor_year_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`ipcr` add index `ix_ipcr_num_inventors` (`num_inventors`)
alter table `PatentsView_20141215_dev`.`ipcr` add index `ix_ipcr_num_assignees` (`num_assignees`)
alter table `PatentsView_20141215_dev`.`location` add index `ix_location_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`location` add index `ix_location_num_inventors` (`num_inventors`)
alter table `PatentsView_20141215_dev`.`location` add index `ix_location_num_assignees` (`num_assignees`)
alter table `PatentsView_20141215_dev`.`location_assignee` add index `ix_location_assignee_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`location_cpc_subsection` add index `ix_location_cpc_subsection_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`location_inventor` add index `ix_location_inventor_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`location_nber_subcategory` add index `ix_location_nber_subcategory_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`location_uspc_mainclass` add index `ix_location_uspc_mainclass_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`location_year` add index `ix_location_year_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`nber` add index `ix_nber_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`nber` add index `ix_nber_num_inventors` (`num_inventors`)
alter table `PatentsView_20141215_dev`.`nber` add index `ix_nber_num_assignees` (`num_assignees`)
alter table `PatentsView_20141215_dev`.`nber_subcategory_patent_year` add index `ix_nber_subcategory_patent_year_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`uspc_current` add index `ix_uspc_current_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`uspc_current` add index `ix_uspc_current_num_inventors` (`num_inventors`)
alter table `PatentsView_20141215_dev`.`uspc_current` add index `ix_uspc_current_num_assignees` (`num_assignees`)
alter table `PatentsView_20141215_dev`.`uspc_current_mainclass` add index `ix_uspc_current_mainclass_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`uspc_current_mainclass` add index `ix_uspc_current_mainclass_num_inventors` (`num_inventors`)
alter table `PatentsView_20141215_dev`.`uspc_current_mainclass` add index `ix_uspc_current_mainclass_num_assignees` (`num_assignees`)
alter table `PatentsView_20141215_dev`.`uspc_current_mainclass_patent_year` add index `ix_uspc_current_mainclass_patent_year_num_patents` (`num_patents`)
alter table `PatentsView_20141215_dev`.`inventor` add index `ix_inventor_lastknown_location_id` (`lastknown_location_id`)
alter table `PatentsView_20141215_dev`.`inventor` add index `ix_inventor_lastknown_persistent_location_id` (`lastknown_persistent_location_id`)
alter table `PatentsView_20141215_dev`.`inventor` add index `ix_inventor_first_seen_date` (`first_seen_date`)
alter table `PatentsView_20141215_dev`.`inventor` add index `ix_inventor_last_seen_date` (`last_seen_date`)
alter table `PatentsView_20141215_dev`.`nber` add index `ix_nber_category_id` (`category_id`)
alter table `PatentsView_20141215_dev`.`assignee` add index `ix_assignee_lastknown_location_id` (`lastknown_location_id`)
alter table `PatentsView_20141215_dev`.`assignee` add index `ix_assignee_lastknown_persistent_location_id` (`lastknown_persistent_location_id`)
alter table `PatentsView_20141215_dev`.`assignee` add index `ix_assignee_last_seen_date` (`last_seen_date`)
alter table `PatentsView_20141215_dev`.`assignee` add index `ix_assignee_first_seen_date` (`first_seen_date`)
