...
# print('...............................')
# print("getting data from temp_rawassignee_persistassignee_disambig....")
# print('making lookup.....')
# print('...............................')
...
for chunk in tqdm.tqdm(data_chunk, desc='persistent_assignee_disambig - batch: ' + str(batch_counter)):
	chunk.to_sql(con=db_con, name='persistent_assignee_disambig', index=False, if_exists='append') # append keeps the indexes
	batch_counter+=1
