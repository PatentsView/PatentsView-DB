...
scp -i "key_file/PV_Apache_Solr.pem" centos@ec2-52-21-62-204.compute-1.amazonaws.com:/data/inventor-disambiguation-internal/data/multi-canopy-output/clean_inventor_results.txt inventor_disambiguation.tsv
