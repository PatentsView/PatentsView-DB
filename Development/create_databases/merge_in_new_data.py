...
tables = ['mainclass',  'cpc_subgroup', 'cpc_current', 'wipo', 'usreldoc', 'figures', 'brf_sum_text', 'patent', 'us_term_of_grant', 'rel_app_text', 'location_assignee', 'assignee', 'rawinventor', 'rawlocation', 'subclass_current', 'usapplicationcitation', 'location', 'nber_category', 'non_inventor_applicant_backup', 'uspatentcitation', 'patent_inventor', 'patent_govintorg_reporting', 'detail_desc_text', 'patent_lawyer', 'nber_subcategory', 'rawlawyer', 'patent_assignee', 'otherreference', 'claim', 'patent_contractawardnumber', 'draw_desc_text', 'wipo_backup', 'ipcr', 'uspc_current', 'location_inventor', 'cpc_group', 'rawexaminer', 'subclass', 'botanic', 'cpc_subsection', 'inventor', 'foreign_priority', 'application','rawassignee']
